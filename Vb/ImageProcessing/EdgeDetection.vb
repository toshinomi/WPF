            ...
            For nIdxHeight = 0 To nHeightSize - 1 Step 1
                For nIdxWidth = 0 To nWidthSize - 1 Step 1
                    ...
                    For nIdxHightMask = 0 To nMasksize - 1 Step 1
                        ...
                        Next
                    Next
                    WriteByte(pAdr, nPos + ComInfo.Pixel.B, ComFunc.LongToByte(dCalB))
                    WriteByte(pAdr, nPos + ComInfo.Pixel.G, ComFunc.LongToByte(dCalG))
                    WriteByte(pAdr, nPos + ComInfo.Pixel.R, ComFunc.LongToByte(dCalR))
                Next
            Next
